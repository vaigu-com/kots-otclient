...
SpellInfo = {
    Default = {
        ...
        ['Lesser Front Sweep'] = {id = 1037, name = 'Lesser Front Sweep', words = 'exori infir min', type = 'Instant', level = 1, mana = 6, soul = 0, maglevel = 0, icon = '', clientId = 160, group = {[1] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 6000, premium = false, vocations = {4, 8}, special = false, source = 0},
        ...
        ['Aura of Sapped Strength'] = {id = 244, name = 'Aura of Sapped Strength', words = 'exori kor tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 202, group = {[3] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0},
        ['Aura of Exposed Weakness'] = {id = 243, name = 'Aura of Exposed Weakness', words = 'exori moe tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 203, group = {[3] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0},
    }
}
